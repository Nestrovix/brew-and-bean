  ...
  <div class="container">
    ...
    <div class="location reveal">
      ...
      <div class="location__info">
        ...
        <div class="info-row"><div class="why__icon"><svg class="ic"><use href="#i-phone"/></svg></div><div><h3>Call or WhatsApp</h3><p><a data-href="tel" href="#"><span data-bind="phoneDisplay">+91 98XXX XXXXX</span></a></p><a class="btn btn--whatsapp mt-2" data-href="whatsapp" href="#" target="_blank" rel="noopener"><svg class="ic"><use href="#i-whatsapp"/></svg> Chat on WhatsApp</a></div></div>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="contact-layout">
      <div class="reveal">
        ...
        <div class="contact-cards mt-4">
          ...
          <div class="contact-card"><div class="why__icon"><svg class="ic"><use href="#i-mail"/></svg></div><div><h3>Email</h3><a class="val" data-href="mail" href="#"><span data-bind="email">hello@brewandbean.in</span></a><p>For catering &amp; private events</p></div></div>
...
<h2 class="mt-4" style="font-size:1.8rem">Contact</h2><p class="mt-2">Questions about your data? Email <a data-href="mail" href="#" style="text-decoration:underline"><span data-bind="email">hello@brewandbean.in</span></a>.</p>
</div></section></main>
''' + footer() + '''</body></html>'''
